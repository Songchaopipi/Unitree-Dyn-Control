...
public:
    ...
    double singleSupportTime{0.3};
    enum class SupportPhase
    {
        DoubleSupport,
        SingleSupport
    };
    SupportPhase supportPhase{SupportPhase::DoubleSupport};
private:
    bool swingFootReadyForSwitch() const;
    bool enterSingleSupport();
    void enterDoubleSupport();
