...
if(NOT aligator_FOUND)
  set(skip_this_file FALSE)
endif()
if(skip_this_file)
  foreach(component ${aligator_FIND_COMPONENTS})
    if(NOT "aligator_${component}_FOUND")
      set(skip_this_file FALSE)
    endif()
  endforeach()
endif()
...
set("aligator_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("ALIGATOR_INCLUDE_DIRS" "${PACKAGE_PREFIX_DIR}/include")
set("aligator_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/aligator/doxygen-html")
set("ALIGATOR_DOXYGENDOCDIR" "${PACKAGE_PREFIX_DIR}/share/doc/aligator/doxygen-html")
set("aligator_DEPENDENCIES" "Eigen3;fmt;Boost;pinocchio")
set("aligator_PKG_CONFIG_DEPENDENCIES" "")
...
set("_aligator_PKG_CONFIG_LIBDIR" "${pcfiledir}/../../lib")
set("_aligator_PKG_CONFIG_LIBS_LIST" " -laligator -L/home/songchao/anaconda3/lib -lboost_filesystem")
if(_aligator_PKG_CONFIG_LIBS_LIST)
  string(FIND ${_aligator_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  while(_is_comma_space GREATER -1)
    string(REPLACE ", " "," _aligator_PKG_CONFIG_LIBS_LIST "${_aligator_PKG_CONFIG_LIBS_LIST}")
    string(FIND ${_aligator_PKG_CONFIG_LIBS_LIST} ", " _is_comma_space)
  endwhile()
  string(REPLACE " " ";" _aligator_PKG_CONFIG_LIBS_LIST "${_aligator_PKG_CONFIG_LIBS_LIST}")
  set(LIBDIR_HINTS ${_aligator_PKG_CONFIG_LIBDIR})
  foreach(component ${_aligator_PKG_CONFIG_LIBS_LIST})
  ...
  endforeach()
endif(_aligator_PKG_CONFIG_LIBS_LIST)

set("aligator_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
set("ALIGATOR_LIBRARIES" ${_PACKAGE_CONFIG_LIBRARIES})
...
IF(COMMAND ADD_REQUIRED_DEPENDENCY)
  FOREACH(pkgcfg_dep ${aligator_PKG_CONFIG_DEPENDENCIES})
...
include("${CMAKE_CURRENT_LIST_DIR}/aligatorTargets.cmake")
...
foreach(component ${aligator_FIND_COMPONENTS})
  ...
  if(EXISTS ${comp_file})
    ...
    set(aligator_${component}_FOUND FALSE)
  endif()
  if(aligator_${component}_FOUND)
    message(STATUS "aligator: ${component} found.")
  else()
    if(aligator_FIND_REQUIRED_${component})
      message(FATAL_ERROR "aligator: ${component} not found.")
    else()
      message(STATUS "aligator: ${component} not found.")
    endif()
  endif()
endforeach()
check_required_components("aligator")


set(ALIGATOR_WITH_PINOCCHIO_SUPPORT ON)
set(ALIGATOR_ENABLE_TEMPLATE_INSTANTIATION ON)
